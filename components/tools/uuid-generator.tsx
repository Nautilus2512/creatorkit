  ...
  return (
    <div className="flex h-full flex-col gap-3 p-4">
      ...
      <div className="grid gap-4 md:grid-cols-2 flex-1 min-h-0">
        {/* Left — Single UUID */}
        <div className="flex flex-col overflow-hidden rounded-xl border border-border bg-card" role="region" aria-label="Single UUID panel">
        ...
        <div className="flex flex-col overflow-hidden rounded-xl border border-border bg-card" role="region" aria-label="Bulk UUID generation panel">

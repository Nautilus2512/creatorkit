...
export default function ImageToText() {
  ...
  return (
    <>
      <div className="flex h-full flex-col gap-3 p-4" role="main" aria-label="Image to Text tool">
        <div>
          <h2 className="text-2xl font-semibold tracking-tight">Image to Text</h2>
          <p className="text-muted-foreground">
            Extract text from images using OCR · 100% in-browser · Press Ctrl+Shift+O to upload · Press ? for shortcuts
          </p>
        </div>

        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 flex-1 min-h-0">
          {/* Left Panel — Upload */}
          <div className="flex flex-col overflow-hidden rounded-xl border border-border bg-card min-w-0" role="region" aria-labelledby="image-panel-label">
          ...
          {/* Right Panel — Results */}
          <div className="flex flex-col overflow-hidden rounded-xl border border-border bg-card min-w-0" role="region" aria-labelledby="results-panel-label">
            <div className="shrink-0 border-b border-border px-4 py-3 flex items-center justify-between">

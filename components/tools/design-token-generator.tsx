        ...
        <div className="space-y-4">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>See your tokens in action.</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              {/* Buttons */}
              <div className="space-y-2">
                ...
                <div className="flex flex-wrap gap-2">
                  <button className="rounded-md px-4 py-2 text-sm font-medium text-white transition-opacity hover:opacity-90" style={{ backgroundColor: primaryShades[600] }}>
                    Primary
                  </button>
                  <button className="rounded-md px-4 py-2 text-sm font-medium text-white transition-opacity hover:opacity-90" style={{ backgroundColor: secondaryShades[600] }}>
                    Secondary
                  </button>
                  <button className="rounded-md px-4 py-2 text-sm font-medium text-white transition-opacity hover:opacity-90" style={{ backgroundColor: accentShades[500] }}>
                    Accent
                  </button>
                  <button className="rounded-md border px-4 py-2 text-sm font-medium transition-colors hover:opacity-80" style={{ borderColor: primaryShades[400], color: primaryShades[500] }}>
                    Outline
                  </button>
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="flex flex-wrap gap-2">
                  ...
                  <span className="rounded-full px-3 py-0.5 text-xs font-medium" style={{ backgroundColor: primaryShades[100], color: primaryShades[700] }}>Subtle</span>
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="rounded-lg border p-4 space-y-2" style={{ borderColor: primaryShades[700], backgroundColor: primaryShades[900] }}>
                  <p className="text-sm font-semibold" style={{ color: primaryShades[100] }}>Sample Card</p>
                  <p className="text-xs" style={{ color: primaryShades[300] }}>This card uses your primary color tokens for background and border.</p>
                  <button className="rounded px-3 py-1 text-xs font-medium text-white" style={{ backgroundColor: primaryShades[600] }}>Action</button>
                </div>
              </div>

              {/* Typography preview */}
              <div className="space-y-1">
                <p className="text-xs font-medium text-muted-foreground">Typography Scale</p>
                <div className="space-y-1 rounded-lg border border-border p-3">
                  {(["5xl", "3xl", "xl", "base", "sm", "xs"] as const).map((size) => (
                    <p key={size} style={{ fontSize: typographyScale[size], color: primaryShades[300], lineHeight: 1.3 }}>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Copy your tokens in your preferred format.</CardDescription>
            </CardHeader>
            <CardContent>

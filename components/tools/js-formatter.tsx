...
export default function JsFormatter() {
  ...
  return (
    <>
      ...
      />
      <div className="flex h-full flex-col gap-3 p-4" role="main" aria-label="JS Formatter tool">
        <div className="flex items-start justify-between flex-wrap gap-2">
          <div>
            <h2 className="text-2xl font-semibold tracking-tight">JS Formatter</h2>
            <p className="text-muted-foreground">Format code with Prettier 2.8.8. Runs entirely in your browser. Press ? for shortcuts.</p>
          </div>
      ...
      <div className="flex gap-4 flex-1 min-h-0">
        {/* Options panel */}
        <div className="shrink-0 flex flex-col overflow-hidden rounded-xl border border-border bg-card w-56" role="region" aria-labelledby="options-panel-label">
          ...
          <div className="flex-1 overflow-y-auto p-4 space-y-5" role="group" aria-label="Formatter options">
        ...
        {/* Code panels — Input */}
        <div className="flex flex-col overflow-hidden rounded-xl border border-border bg-card flex-1" role="region" aria-labelledby="input-panel-label">
          <div className="shrink-0 border-b border-border px-4 py-3 flex items-center justify-between">
            <span className="text-xs font-semibold text-muted-foreground uppercase tracking-wide" id="input-panel-label">Input</span>
            <Button 
              size="sm" 
              onClick={() => { format() }} 
              disabled={status !== "ready"}
              className="h-7 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2"
            ...
            >
              ...
              <kbd className="ml-2 rounded border border-primary-foreground/30 bg-primary-foreground/10 px-1 text-[10px] opacity-60" aria-hidden="true">Ctrl+Shift+F</kbd>
            </Button>
          </div>
          <Textarea 
            value={code} 
        ...
        {/* Output */}
        <div className="flex flex-col overflow-hidden rounded-xl border border-border bg-card flex-1" role="region" aria-labelledby="output-panel-label">
          <div className="shrink-0 border-b border-border px-4 py-3 flex items-center justify-between">
            <span className="text-xs font-semibold text-muted-foreground uppercase tracking-wide" id="output-panel-label">Output</span>
            <div className="flex items-center gap-1">
              <Button 
                ...
                disabled={!formatted} 
                className="h-7 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2"
                aria-label={copied ? "Copied to clipboard" : "Copy formatted code to clipboard"}
              >
              ...
              <Button 
                ...
                disabled={!formatted} 
                className="h-7 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2"
                aria-label={downloaded ? "File downloaded" : "Download formatted file"}
              >
                {downloaded ? <FileCheck className="h-3.5 w-3.5 mr-1" /> : <Download className="h-3.5 w-3.5 mr-1" aria-hidden="true" />}

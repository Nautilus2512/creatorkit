    ...
    <div className="flex flex-col bg-background md:h-screen">
      ...
      <div className="shrink-0 border-b border-border bg-background">
        <div className="px-6 py-4">
          <h1 className="text-xl font-semibold">TOTP / 2FA Generator</h1>
          <p className="text-sm text-muted-foreground">Generate TOTP codes from a base32 secret. Compatible with Google Authenticator. Nothing leaves your browser.</p>
        </div>
      </div>
      ...
      <div className="flex-1 flex flex-col md:flex-row overflow-y-auto md:overflow-hidden">
        ...
        <div className="flex flex-col md:w-1/2 md:flex-1">
          <div className="p-3 border-b border-border bg-muted/30">
            <h3 className="text-sm font-medium">Current Code</h3>
          </div>

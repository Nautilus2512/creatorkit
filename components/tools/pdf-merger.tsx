...
export function PDFMerger() {
  ...
  const hasResult = (mode === 'merge' && mergeResult) || (mode === 'split' && splitResults.length > 0)
    ...
    <>
      ...
      <div className="flex flex-1 flex-col min-h-0">
        ...
        <div className="hidden md:flex shrink-0 items-center gap-2 border-b border-border bg-card/95 backdrop-blur-sm px-4 py-2">
          <span className="text-sm font-semibold shrink-0 mr-1">PDF Merger &amp; Splitter</span>
          <div className="ml-auto flex items-center gap-1.5">
            <ShortcutsModal pageName="PDF Merger & Splitter" shortcuts={shortcuts} />
            <Button
              size="sm"
        ...
        <div className="flex md:hidden flex-col shrink-0 border-b border-border">
          <div className="flex items-center justify-between px-4 pt-3 pb-1">
            <h2 className="text-base font-semibold">PDF Merger</h2>
            <ShortcutsModal pageName="PDF Merger & Splitter" shortcuts={shortcuts} />
          </div>
              ...
              <div className="flex-1 overflow-y-auto p-4 space-y-6" id="settings-label">
                ...
                {mode === 'merge' ? (
                  ...
                  <div role="tabpanel" id="split-panel" aria-label="Split PDF file">
                    ...
                    {splitFile && (
                      <div className="space-y-3 mt-4" role="group" aria-labelledby="page-ranges-label">

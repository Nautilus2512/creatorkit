...
const toolCards = [
  ...
  },
  {
    ...
    description: "Scientific calculator with trig (DEG/RAD), logarithms, graphing, numerical calculus, physical constants, and memory. Powered by mathjs.",
    ...
    <>
      ...
      <ShortcutsModal
        ...
        shortcuts={[
          ...
          { keys: ["`"], description: "Open Scientific Calculator" },

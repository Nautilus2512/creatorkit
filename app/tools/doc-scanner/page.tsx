...
export const metadata: Metadata = {
  title: "Document Scanner - CreatorKit",
  description: "Upload any document photo and drag 4 corner handles to align with the edges. Scan for a clean, perspective-corrected image with brightness and contrast controls.",
}

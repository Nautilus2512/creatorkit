...
export const metadata: Metadata = {
  ...
  description: "Scan documents with your camera. Drag 4 corner handles, then hit Scan for perspective-corrected output with brightness and contrast controls.",
}
